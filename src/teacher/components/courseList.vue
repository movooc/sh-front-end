  ...
  <div class="course-list">
    ...
    <ul>
      ...
      <li v-for="list in lists">
        <span>
          <span class="tag" @click="jumpToSeries(list.category, list.categoryInfo.name)" v-if="list.category">系列课</span>
          {{list.title}}
        </span>
        <span>
...
<script>
    ...
    export default{
      ...
      methods: {
        ...
        jumpToSeries(series_sn, title) {
          // 进入系列课详情
          this.$router.push({ name: 'singleList', params: { series_sn: series_sn, title: title }});
        },
